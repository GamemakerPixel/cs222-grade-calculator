...
NUMERIC_INPUT_REMINDER = ("Invalid input, please enter an integer between "
                          "{min} and {max}.")
...
PROJECT_PROMPT = ("What grade did you get for the {project_name} project "
...
GRADE_REPORT = "Your final grade: {grade}"
